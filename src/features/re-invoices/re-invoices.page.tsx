...
export function ReInvoicesPage() {
  ...
  return <div className="flex flex-1 flex-col gap-5">
    <PageHeader badge="الإدارة المالية" title="المرتجعات" icon={Undo2} action={<Button onClick={() => { setFundId(undefined); setFundPickerOpen(true); }}><Plus className="size-4" />إنشاء مرتجع</Button>} />
