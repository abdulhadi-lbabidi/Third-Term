import { File as FileIcon, MoreVertical, Pencil, Trash2, Download, Image as ImageIcon, FileText, Eye } from 'lucide-react';
...
export function FileCard({ file, selected, onSelect, onRename, onDelete, onDownload, onPreview }: FileCardProps) {
