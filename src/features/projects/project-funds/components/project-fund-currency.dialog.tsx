...
import type { ProjectFundCurrency } from '../project-funds.types';
import { attachProjectCurrencySchema, type AttachProjectCurrencyValues } from '../../schemas/projects.schema';

type ProjectFundCurrencyDialogProps = {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  currency?: ProjectFundCurrency | null;
  onSubmit: (values: { currency_id: number; balance: string }) => Promise<void>;
  loading?: boolean;
};

export function ProjectFundCurrencyDialog({
  open,
  onOpenChange,
  currency,
  onSubmit,
  loading,
}: ProjectFundCurrencyDialogProps) {
