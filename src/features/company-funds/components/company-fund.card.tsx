...
type CompanyFundCardProps = {
  fund: CompanyFund;
  onClick: (fund: CompanyFund) => void;
  onMoreCurrenciesClick?: (fund: CompanyFund) => void;
};

export function CompanyFundCard({
  fund,
  onClick,
  onMoreCurrenciesClick,
}: CompanyFundCardProps) {
          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">صندوق شركة</p>
              </div>
            </div>
